...
;; (find-file "~/.emacs.d/init/python.el")
;; (find-file "~/.emacs.d/config/flake8rc.ini")
;; (find-file "~/.emacs.d/init/python.el")
;; (find-file "/home/michael/linkcube/src/base/assets/sass/_lc__linkcube.scss")
;; (find-file "~/.emacs.d/init/programming.el")
;;(find-file "/home/michael/linkcube/src/base/views.py")
;; (find-file "~/.emacs.d/michael-theme.el")
;; (find-file "~/.emacs.d/init/mode-line.el")
;;(find-file "~/temp.py")
(find-file "~/.emacs.d/init.el")
(find-file "~/.emacs.d/init/evil.el")
